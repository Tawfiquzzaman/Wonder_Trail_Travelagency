...
{
  $button_name=  "<a href=''><button type='button'class='btn  btn-secondary'><ion-icon  id='login-btn'  name='person-circle-outline'></ion-icon>". $_SESSION['username']." </button></a> <a class='logout' href='./login/logout.php'>Logout</a>";
